...
import { useCartCategoryCount } from "@/hooks/useCartCategoryCount";
...
export default function BuilderSteps() {
  ...
  const planCount = useCartCategoryCount("plans");
  const sensorCount = useCartCategoryCount("sensors");
  const accessoriesCount = useCartCategoryCount("accessories");
